...
/*   Updated: 2023/04/03 18:01:15 by bcarreir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::attack(const std::string& target)
{
	if (!checkStats())
		return ;
	this->_energyPoints--;
	std::cout << this->_name << "\e[0;33m slapped the living sh*t outta \e[0m" << target << " " << this->_attackDamage << "\e[0;33m times.\e[0m" << std::endl;
}
...
void ClapTrap::takeDamage(unsigned int amount)
{
	...
	std::cout << this->_name << "\e[0;31m took \e[0m" << amount << "\e[0;31m roundhouse kicks. Total HP: \e[0m" << this->_hitPoints << std::endl;	
}
...
void ClapTrap::beRepaired(unsigned int amount)
{
	...
	this->_energyPoints--;
	this->_hitPoints += amount;
	std::cout << this->_name << "\e[0;32m repaired himself for \e[0m" << amount << "\e[0;32m. Total HP: \e[0m" << this->_hitPoints << std::endl;	
}
